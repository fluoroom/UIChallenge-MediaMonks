...
const Home: VoidFunctionComponent = () => (
  <div className={styles.container}>
    ...
    <Step title="Are you ready for your first challenge at Media.Monks?"
    fontColor="#DFBBFE" backgroundColor="#2C2D38"/>
    <Step title="Simplicity is the way to go when considering user experience."
    ...
    <Step title="More people are using their mobile devices to browse the web."
